        ...
        chapters: [
            {
                ...
                lessons: [
                    ...
                    },
                    {
                        ...
                        content: [
                            'El retoque fotográfico es una de las aplicaciones más populares de Photoshop, permitiendo a los usuarios mejorar y transformar imágenes de manera profesional. En esta lección, aprenderás a utilizar herramientas esenciales como el Pincel de ajuste, el Pincel corrector y el tampón de clonar para corregir imperfecciones y realzar detalles en tus fotografías. Estas herramientas son fundamentales para eliminar manchas, arrugas o cualquier distracción no deseada, logrando un acabado limpio y atractivo.',
                            'También conocerás como realizar mejorar la piel con diferentes técnicas, como el uso pinceladas de color, el uso de diferentes capas entre otros, todo para que nuestra imagen presente el minimo de inperfecciones, pero siempre manteniendo la naturaleza y belleza humana. Cuando retocamos fotos es muy importante dar el mejor resultado posible, pero siempre manteniendo la esencia de la persona.',
                        ],
                        videoUrl: 'AbPZYS02z2FFyTGHQkf6YikRIWXcwPDUY01pcaR8Idw2A',
                        posterUrl: 'https://image.mux.com/AbPZYS02z2FFyTGHQkf6YikRIWXcwPDUY01pcaR8Idw2A/animated.webp?fit_mode=preserve&start=0&end=4',
                        driveUrl: 'https://1drv.ms/f/c/5c0044e92b33f270/EjGHT5IfaopMvxRKXrOP9rcBXkNT11RHywTiSvec9zUyUQ?e=T1R04g'
                    },
                    {
                        _id: 106,
            ...
            },
            {
                ...
                lessons: [
                    ...
                    },
                    {
                        ...
                        content: [
                            'En esta lección exploraremos los principios de composición gráfica, centrándonos en la creación de una línea gráfica coherente a partir de tres ilustraciones vectoriales con un estilo unificado. A través de este ejercicio, aprenderemos a estructurar un diseño atractivo y equilibrado para aplicarlo en un post promocional para un restaurante de comida rápida. La clave estará en mantener la armonía visual entre las ilustraciones, asegurando que cada elemento contribuya a la identidad de la marca y refuerce el impacto del mensaje.',
                    ...
                    },
                    {
                        ...
                        content: [
                            'En esta lección de diseño gráfico exploraremos diversas técnicas avanzadas para potenciar la creatividad y precisión en Adobe Illustrator. Comenzaremos aprendiendo cómo adaptar un vector a la forma de otro, una herramienta esencial para diseñadores que buscarán integrar elementos con fluidez y coherencia visual. Luego, analizaremos la técnica de Blend, que nos permitirá generar transiciones suaves entre dos vectores mediante copias progresivas, brindando efectos dinámicos y estructurados.',
...

                    {
                        ...
                        content: [
                            'En esta segunda parte de la lección de diseño gráfico, exploraremos herramientas y efectos avanzados en Adobe Illustrator para llevar nuestras composiciones a un nivel más dinámico y estilizado. Comenzaremos con técnicas como Free Distort, que permitirá modificar libremente la forma de los objetos, y Repeat en modo Grid, que será ideal para generar patrones repetitivos de manera rápida y eficiente. También trabajaremos con Split Into Grid, que será una opción perfecta para dividir elementos en secciones organizadas, lo que facilitará la estructuración y distribución en nuestros diseños.',
            ...
            },
            {
                ...
                lessons: [
                    ...
                    },
                    {
                        ...
                        title: 'Interfaz y herramientas',
                        content: [
                            'En esta lección de Interfaz y Herramientas de After Effects, nos adentraremos en el entorno de trabajo del programa, explorando los paneles, menús y herramientas que te permitirán llevar a cabo procesos de animación y composición de manera eficaz. Comprenderemos cómo cada elemento de la interfaz se integra para facilitar la organización y manipulación de contenidos, permitiéndote acceder rápidamente a las funcionalidades que potenciarán tu flujo de trabajo creativo.',
                    ...
                    },
                    {
                        ...
                        title: 'Keyframes',
                        content: [
                            'En esta lección nos adentraremos en el fascinante mundo de los keyframes, la columna vertebral del control de la animación en After Effects. Exploraremos cómo la configuración de keyframes permite definir con precisión los cambios en la velocidad y la posición de los elementos a lo largo del tiempo. Al comprender y manipular estos puntos clave, podrás transformar animaciones básicas en movimientos dinámicos y fluidos, estableciendo transiciones que doten de naturalidad a cada escena.',
                    ...
                    },
                    {
                        ...
                        content: [
                            'En esta lección nos adentraremos en el apasionante mundo de los motion graphics, donde aprenderemos a dar vida a figuras y elementos gráficos a través de animaciones dinámicas. Exploraremos la metodología para transformar composiciones estáticas en narrativas visuales vibrantes, utilizando el poder de la animación para transmitir ideas y emociones de manera impactante.',
                    ...
                    },
                    {
                        ...
                        content: [
                            'En esta lección exploraremos el proceso de rotoscopia aplicado a efectos visuales, trabajando con un video en el que figura una persona. Aplicaremos la técnica de rotoscopia para separar de manera precisa al sujeto del fondo, lo que nos permitirá aislarlo y preparar la base para el posterior tratamiento de imagen. Este paso es fundamental para obtener un mayor control sobre la aplicación de los efectos que transformarán y potenciarán la narrativa visual.',
                    ...
                    },
                    {
                        ...
                        title: '3D Clásico',
                        content: [
                            'En esta lección nos adentraremos en el mundo del 3D clásico en After Effects, explorando la creación y animación de textos y figuras en un entorno tridimensional. Utilizaremos la cámara para posicionarnos y navegar dentro del espacio 3D, aprendiendo a aprovechar las diferentes vistas que el ambiente ofrece para obtener una mejor perspectiva de nuestros elementos y darles profundidad.',
                    ...
                    },
                    {
                        ...
                        content: [
                            'En esta lección nos centraremos en el trackeo 3D, una técnica esencial en After Effects que nos permitirá extraer y seguir los movimientos de la cámara para recrear y entender el espacio tridimensional de una escena. Utilizaremos el trackero de cámara para analizar el movimiento y posicionar de forma precisa efectos visuales en el video, creando una integración fluida entre elementos reales y digitales.',
                    ...
                    },
                    {
                        ...
                        title: 'Proyecto Final',
                        content: [
                            'En esta lección final nos enfocaremos en la realización de efectos específicos que se utilizan ampliamente en social media. Abordaremos técnicas para crear textos que complementen al sujeto, transiciones dinámicas que aporten movimiento y energía, y métodos para separar al sujeto del background, lo que nos permitirá aplicar efectos personalizados en el fondo. Esta combinación de técnicas te preparará para transformar tus videos en piezas audiovisuales atractivas y adaptadas al lenguaje visual de las redes sociales.',
